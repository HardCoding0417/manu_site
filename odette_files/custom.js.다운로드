...
jQuery(document).ready(function($){
	$("a.trigger-footer").click(function(){
		if ($("a.trigger-footer").html() == "View more"){
			$("a.trigger-footer").html("View less");
		}
		else{
			$("a.trigger-footer").html("View more");
		}
...
jQuery(document).ready(function($){
	...
	if (window_width >= 1820) num_columns = 4;
	if (window_width < 1820) num_columns = 4;
	if (window_width < 1560) num_columns = 4;
